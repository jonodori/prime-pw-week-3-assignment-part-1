...
let favFoods = ['tacos', 'sushi', 'ramen', 'fried chicken']

// 1.b. TODO: Log your array of foods to the console with a message, similar 
//      to the example above
console.log('My favorite foods: ', favFoods);
...
console.log('Added a favorite food to end,', favFoods);
...
favFoods.unshift('pizza');
console.log(`Added a favorite food to beginning: ${favFoods}`);
...
const newArray = favFoods.concat(animalArray);
